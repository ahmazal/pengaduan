...
export default function NavUser() {
  ...
  const hoverItem =
    "hover:bg-indigo-50 hover:scale-[1.02] cursor-pointer transition-all duration-200";
      ...
      >
        ...
        <nav className="mt-4 flex flex-col gap-3">
          <button
            ...
            className={`flex items-center gap-3 px-3 py-2 rounded-lg hover:shadow ${hoverItem}`}
          >
            <Gauge size={20} />
